...
Additionaly if you have a backup file from an existing {partner-product-short-name} deployment, you can provide this file during the deployment phase to configure your new WAF instances.
