...
. Sign in to your AWS account.
. Open the page for the {partner-product-short-name} AMI in {marketplace_listing_url}[AWS Marketplace], and then choose *Continue to Subscribe*.
...
[cols=2*]
|===
^|https://fwd.aws/JjJEy[Deploy {partner-product-short-name} into a new VPC on AWS^]
^|https://fwd.aws/qBea3[View template^]

^|https://fwd.aws/PM7vR[Deploy {partner-product-short-name} into an existing VPC on AWS^]
^|https://fwd.aws/vmwg7[View template^]
|===
