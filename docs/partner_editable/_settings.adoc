...
:partner-contributors: Brett Wolmarans, Michael Collins, {partner-company-name}
:quickstart-contributors: Troy Ameigh, Reese Pitman, {quickstart-team-name}
...
:marketplace_listing_url: https://aws.amazon.com/marketplace/pp/B014GEC526?qid=1590536656862&sr=0-2&ref_=srh_res_product_title
